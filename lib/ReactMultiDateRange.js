            ...
            react_1.default.createElement("div", { className: "arrows-container" },
                react_1.default.createElement("button", { onClick: goToPreviousMonth, style: { backgroundColor: "transparent", borderWidth: 0 } },
                    react_1.default.createElement("span", null,
                        react_1.default.createElement("i", { className: "fa-solid fa-arrow-left", style: { color: textColor } }))),
                ...
                react_1.default.createElement("button", { onClick: goToNextMonth, style: { backgroundColor: "transparent", borderWidth: 0 } },
                    react_1.default.createElement("span", null,
                        react_1.default.createElement("i", { className: "fa-solid fa-arrow-right", style: { color: textColor } }))))),
        react_1.default.createElement("div", null,
            GuildComponent && (react_1.default.createElement("div", { className: "month-details-container--header-container", style: {
                    backgroundColor: theme === "light" ? "lightGray" : "#383838",
                    border: borderColor ? "1px solid ".concat(borderColor) : "none",
                    padding: "10px",
                    borderRadius: "10px",
                } },
                react_1.default.createElement("i", { className: "material-icons", style: { color: "lightBlue" } }, "info"),
